...
function MensajesES ()
{
    ...
    return 'Hola,\n\nComo alumno del Programa '+this._programa.getNombre()+' debes responder al siguiente test de comprobación de conocimiento ('+link_formulario+').\n';
    }


    this.getMensajeEmailWorkshop=function(evaluados,link_formulario,workshop)
    {
      return 'Hola,\nCompleta el <a target="_blank" href="'+link_formulario+'">siguiente formulario de valoración</a> del trabajo del <b>workshop de '+workshop+'</b> realizado por: <r>'+evaluados+'</r>\n';
    }
    this.getMensajeEmailWorkshopTXT=function(evaluados,link_formulario,workshop)
    {
      return 'Hola,\n\nCompleta el siguiente formulario de valoración ('+link_formulario+') del trabajo del workshop de '+workshop+' realizado por: '+evaluados;
    }
}
...
function MensajesEN ()
{
    ...
    this.getMensajeEmailWorkshop=function(evaluados,link_formulario,workshop)
    {
      return 'Hello,\nComplete the <a target="_blank" href="'+link_formulario+'">following form</a> that will you allow to evaluate the work done for the <b>'+workshop+' workshop</b> carried out by: <r>'+evaluados+'</r>\n';
    }
    this.getMensajeEmailWorkshopTXT=function(evaluados,link_formulario,workshop)
    {
      return 'Hello,\n\nComplete the following form ('+link_formulario+') that will you allow to evaluate the work done for the '+workshop+' workshop carried out by: '+evaluados;
    }
}
